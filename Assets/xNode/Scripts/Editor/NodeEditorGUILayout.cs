                ...
                if (port.direction == XNode.NodePort.IO.Input) {
                    ...
                    switch (showBacking) {
                        case XNode.Node.ShowBackingValue.Unconnected:
							...
							// MGB start: show tooltip if connected.
							TooltipAttribute tooltipAttrib;
							NodeEditorUtilities.GetAttrib(port.node.GetType(), property.name, out tooltipAttrib);
							string tt = tooltipAttrib != null ? tooltipAttrib.tooltip : "";
                            if (port.IsConnected) EditorGUILayout.LabelField(label != null ? label : new GUIContent(property.displayName, tt));
							// MGB end
